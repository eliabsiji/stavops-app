...
<!--begin::Custom Javascript(used for this page only)-->
    ...
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/myjournal/view/view.js')}}"></script>
    <script src="{{ asset('html/assets/assets/js/custom/apps/user-management/myjournal/view/update-myjournal.js')}}"></script>
