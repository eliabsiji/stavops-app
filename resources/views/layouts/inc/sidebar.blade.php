                ...
                @endrole
                    ...
                    <!--end:Menu item-->
                       ...
                       <div class="menu-item pt-5">
                        <!--begin:Menu content-->
                        <div class="menu-content">
                            <span class="menu-heading fw-bold text-uppercase fs-7">Management Systems</span>
                        </div>
                        <!--end:Menu content-->
                    </div>
                    <!--end:Menu item-->
                      ...
                      <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <span class="menu-link">
                            ...
                            <span class="menu-title">Staff Managements</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                    ...
                    <!--end:Menu item-->
                     ...
                     <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <span class="menu-link">
                            ...
                            <span class="menu-title">Non Academics</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                    ...
                    <!--end:Menu item-->
                     ...
                     <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <span class="menu-link">
                            ...
                            <span class="menu-title">Appraisal Management</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                  ...
                  {{-- user profile here --}}
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <span class="menu-link">
                            ...
                            <span class="menu-title">APER Academic</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <span class="menu-link">
                            ...
                            <span class="menu-title">APER Senior Staff</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('senior_aper_part_a.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Part A</span>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('senior_aper_part_b.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Part B</span>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('senior_aper_part_c.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Part C</span>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('senior_aper_part_d.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Part D</span>
                            ...
                            <!--end:Menu item-->
                              ...
                              <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('senior_aper_part_e.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Part E</span>
                    ...
                    <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                        ...
                        <span class="menu-link">
                            ...
                            <span class="menu-title">APER Junior Staff</span>
                            <span class="menu-arrow"></span>
                        </span>
                        <!--end:Menu link-->
                        <!--begin:Menu sub-->
                        <div class="menu-sub menu-sub-accordion">
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('junior_aper_part_a.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Part A</span>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('junior_aper_part_b.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Part B</span>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('junior_aper_part_c.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Part C</span>
                            ...
                            <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('junior_aper_part_d.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Part D</span>
                            ...
                            <!--end:Menu item-->
                              ...
                              <div class="menu-item">
                                <!--begin:Menu link-->
                                <a class="menu-link" href="{{ route('junior_aper_part_e.index') }}">
                                    <span class="menu-bullet">
                                        <span class="bullet bullet-dot"></span>
                                    </span>
                                    <span class="menu-title">Part E</span>
                    ...
                    <div class="menu-item pt-5">
                        <!--begin:Menu content-->
                        <div class="menu-content">
                            <span class="menu-heading fw-bold text-uppercase fs-7">Institution Basic Settings</span>
                        </div>
                        <!--end:Menu content-->
                    </div>
                    <!--end:Menu item-->
