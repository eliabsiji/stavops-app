...
<div class="card mb-5 mb-xl-10">
    ...
    <div class="row mb-6">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Current Grade and Date Appointed or Promoted to Current Grade</label>
        <!--end::Label-->
        ...
        <div class="col-lg-8">
            ...
            <div class="row">
                <!--begin::Col-->
                <div class="col-lg-6 fv-row">
                    Grade:<input type="text" name="dateofpromotion" class="form-control form-control-lg form-control-solid mb-3 mb-lg-0"
                ...
                <!--begin::Col-->
                <div class="col-lg-6 fv-row">
                   Date: <input type="date" name="gradeofpromotion" class="form-control form-control-lg form-control-solid" 
                   placeholder=""  required />
                </div>
                <!--end::Col-->
            </div>
    ...
    <div class="row mb-6">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required  fw-semibold fs-6">Acting Appointment held during period of Report</label>
        <!--end::Label-->
    
        <!--begin::Col-->
        <div class="col-lg-8 fv-row">
            <input type="text" name="courses" class="form-control form-control-lg form-control-solid" 
            placeholder="Acting Appointment held during period of Report" required />
        </div>
        <!--end::Col-->
    </div>
    <!--end::Input group-->
    ...
    <div class="row mb-6">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required  fw-semibold fs-6">Courses and conferences attended during the period of Report</label>
        <!--end::Label-->
    
        <!--begin::Col-->
        <div class="col-lg-8 fv-row">
            <textarea name="courses" class="form-control form-control-lg form-control-solid" 
            placeholder="Courses  and conferences attended during the period of Report" required></textarea>
        </div>
        <!--end::Col-->
    </div>
    <!--end::Input group-->
    ...
    <div class="row mb-6">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required fw-semibold fs-6">Professional Qualifications 3</label>
        <!--end::Label-->
    ...
    <div class="row mb-6">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required  fw-semibold fs-6">Experience outside the polytechnic (Describe briefly positions held and duties performed before joining this polytechnic. Please indicate institutions, your designation, your area of specialization, dates in such a way to give a clear chronological picture of your post qualification experience).</label>
        <!--end::Label-->
    ...
    <!--end::Input group-->
     ...
     <div class="row mb-6">
        ...
        <label class="col-lg-4 col-form-label required  fw-semibold fs-6">
            (b)	Experience at The Federal Polytechnic, Ile-Oluji, Ondo State:
(i)	  Job Description prior to the period of report (Describe briefly the positions held and duties performed prior to the period of the Report) 
        </label>
        <!--end::Label-->
    ...
    <!--end::Input group-->
     ...
     <div class="row mb-6">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required  fw-semibold fs-6">
            Present Job: job description
            (a)	State below in order of importance the main official duties performed during the time of Report:
    ...
    <div class="row mb-6">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required  fw-semibold fs-6">
            State any important adhoc duties performed which are not of a continuous nature
        </label>
        <!--end::Label-->
    ...
    <div class="row mb-6">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required  fw-semibold fs-6">
            Other Activities within the polytechnic (Contributions to the Polytechnic)
        </label>
        <!--end::Label-->
    ...
    <!--end::Input group-->
      ...
      <div class="row mb-6">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required  fw-semibold fs-6">
            Other Activities outside normal Polytechnic Work (Contributions to the Nation)
        </label>
        <!--end::Label-->
    ...
    <!--end::Input group-->
      ...
      <div class="row mb-6">
        <!--begin::Label-->
        <label class="col-lg-4 col-form-label required  fw-semibold fs-6">
        	Publications (in Recognized Journals Only)
        </label>
        <!--end::Label-->
