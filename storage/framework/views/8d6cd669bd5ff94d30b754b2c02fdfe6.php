            ...
            <td class="text-end">
                ...
                <!--begin::Menu-->
                     <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('alljournal-list')): ?>
                            <!--begin::Menu item-->
                            <div class="menu-item px-3">
                                <a href="<?php echo e(route('authors.show',$user->jid)); ?>" class="menu-link px-3">
                                View Journal
                                </a>
                            </div>
                            <!--end::Menu item-->
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stavops-app\resources\views/journalauthors/alljournals.blade.php ENDPATH**/ ?>