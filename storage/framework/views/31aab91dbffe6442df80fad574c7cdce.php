        ...
        <ul class="breadcrumb breadcrumb-separatorless fw-semibold fs-7 my-0 pt-1">
                            <!--begin::Item-->
                             <li class="breadcrumb-item text-muted">
                                 <a href="<?php echo e(route('users.index')); ?>" class="text-muted text-hover-primary">Journals & Publications</a>
                                            </li>
                                <!--end::Item-->
                                    <!--begin::Item-->
...
<div class="modal-dialog modal-dialog-centered mw-650px">
    ...
    <div class="modal-content">
        ...
        <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
            <!--begin::Form-->
            <form id="kt_modal_add_user_form" class="form" action="<?php echo e(route('myjournals.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                <!--begin::Scroll-->
                        ...
                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('myjournals-edit')): ?>
                         ...
                         <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('myjournals-delete')): ?>
                            ...
                            <div class="menu-item px-3" >
                                ...
                                data-url="<?php echo e(route('myjournal.deletejournal', ['journalid'=>$j->jid])); ?>"
...
<?php echo $__env->make('layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\stavops-app\resources\views/myjournal/index.blade.php ENDPATH**/ ?>