...
<!--end::Vendors Javascript-->
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/inbox/compose.js')); ?>"></script>

<!--begin::Custom Javascript(used for this page only)-->
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/myjournal/list/add.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/myjournal/view/view.js')); ?>"></script>
    <script src="<?php echo e(asset('html/assets/assets/js/custom/apps/user-management/myjournal/view/update-myjournal.js')); ?>"></script>
...
<!--end::Javascript-->
<?php /**PATH C:\xampp\htdocs\stavops-app\resources\views/layouts/pages-assets/js/myjournal-list-js.blade.php ENDPATH**/ ?>