...
<head>
    ...
    <title> Home </title>
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="<?php echo e(asset('dapafue/assets/images/favicons/apple-touch-icon.png')); ?>" />
    ...
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/bootstrap/css/bootstrap.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/animate/animate.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/animate/custom-animate.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/fontawesome/css/all.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/jarallax/jarallax.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/nouislider/nouislider.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/nouislider/nouislider.pips.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/odometer/odometer.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/swiper/swiper.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/flaticon/style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/tiny-slider/tiny-slider.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/reey-font/stylesheet.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/owl-carousel/owl.carousel.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/owl-carousel/owl.theme.default.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/bxslider/jquery.bxslider.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/bootstrap-select/css/bootstrap-select.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/vegas/vegas.min.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/jquery-ui/jquery-ui.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/timepicker/timePicker.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/vendors/polyglot-language-switcher/polyglot-language-switcher.css')); ?>" />

    <!-- template styles -->
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/css/ontech.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('dapafue/assets/css/ontech-responsive.css')); ?>" />
</head>
...
<body class="custom-cursor">
    ...
    <div class="page-wrapper">
                        ...
                        <div class="container">
                            <div class="main-header-one__bottom-inner" style="background-color: darkgreen";>
                                ...
                                <div class="main-header-one__bottom-left" style="background-color: darkgreen";>
                                    <div class="logo-one">
                                        <a href="index.html"><img src="<?php echo e(asset('dapafue/assets/images/resources/logo-1.png')); ?>" alt="#"></a>
                                    </div>
            ...
            <div class="main-slider-one__inner">
                <div class="main-slider__carousel owl-carousel owl-theme thm-owl__carousel"
                    ...
                    <div class="main-slider-one__single">
                        ...
                        <div class="shape2"><img src="<?php echo e(asset('dapafue/assets/images/shapes/slider-v2-shape1.png')); ?>" alt="#"></div>
        ...
        <section class="about-two">
            <div class="shape8"><img src="<?php echo e(asset('dapafue/assets/images/shapes/about-v2-shape4.png')); ?>" alt="#"></div>
            <div class="shape9 rotate-me"><img src="<?php echo e(asset('dapafue/assets/images/shapes/about-v2-shape5.png')); ?>" alt="#"></div>
            <div class="container">
                <div class="row">
                    <!--Start About Two Img-->
                    <div class="col-xl-5 wow fadeInLeft" data-wow-delay="100ms" data-wow-duration="1500ms">
                        <div class="about-two__img clearfix">
                            <div class="shape1"><img src="<?php echo e(asset('dapafue/assets/images/shapes/about-v2-shape1.png')); ?>" alt="#"></div>
                            <div class="shape2 rotate-me"><img src="<?php echo e(asset('dapafue/assets/images/shapes/about-v2-shape2.png')); ?>" alt="#">
                            </div>
                            <img src="<?php echo e(asset('dapafue/assets/images/about/about-v2-img1.jpg')); ?>" alt="#">
                        </div>
                    </div>
                    <!--End About Two Img-->
                        ...
                        <div class="about-two__content">
                            <div class="sec-title">
                                <div class="sec-title__tagline">
                                    <div class="inner">
                                        <div class="round-box"><img src="<?php echo e(asset('dapafue/assets/images/shapes/sec-title-shape.png')); ?>"
                                                alt="#">
                                        </div>
                                        <div class="text">
                                            <p>ABOUT US</p>
                                ...
                                <div class="row">
                                    <div class="col-xl-8 col-lg-8 col-md-8">
                                        <div class="about-two__content-text3-left">
                                            ...
                                            <div class="img-box">
                                                <div class="shape5"><img src="<?php echo e(asset('dapafue/assets/images/shapes/about-v2-shape3.png')); ?>"
                                                        alt="#"></div>
                                                <div class="shape6"><img src="<?php echo e(asset('dapafue/assets/images/shapes/about-v2-shape3.png')); ?>"
                                                        alt="#"></div>
                                                <div class="shape7"><img src="<?php echo e(asset('dapafue/assets/images/shapes/about-v2-shape3.png')); ?>"
                                                        alt="#"></div>
                                                <img src="<?php echo e(asset('dapafue/assets/images/about/about-v2-img2.jpg')); ?>" alt="#">
                                            </div>
        ...
        <section class="projects-one projects-one--two">
            <div class="shape5"><img src="<?php echo e(asset('dapafue/assets/images/shapes/projects-v1-shape5.png')); ?>" alt="#"></div>
            <div class="shape6"><img src="<?php echo e(asset('dapafue/assets/images/shapes/projects-v1-shape6.png')); ?>" alt="#"></div>
            <div class="container">
                <div class="sec-title text-center">
                    <div class="sec-title__tagline">
                        <div class="inner">
                            <div class="round-box"><img src="<?php echo e(asset('dapafue/assets/images/shapes/sec-title-shape.png')); ?>" alt="#">
                            </div>
                            <div class="text">
                ...
                <div class="row">
                    ...
                    <div class="col-xl-4 wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <div class="projects-one__single">
                            <div class="projects-one__single-img">
                                <div class="inner">
                                    <img src="<?php echo e(asset('dapafue/assets/images/project/projects-v2-img1.jpg')); ?>" alt="#">
                                </div>
                            </div>

                            <div class="projects-one--two__content">
                                <div class="shape1"><img src="<?php echo e(asset('dapafue/assets/images/shapes/projects-v1-shape1.png')); ?>" alt="#">
                                </div>
                                <div class="shape2"><img src="<?php echo e(asset('dapafue/assets/images/shapes/projects-v1-shape2.png')); ?>" alt="#">
                                </div>
                                <div class="shape3"><img src="<?php echo e(asset('dapafue/assets/images/shapes/projects-v1-shape3.png')); ?>" alt="#">
                                </div>
                                <div class="shape4"><img src="<?php echo e(asset('dapafue/assets/images/shapes/projects-v1-shape4.png')); ?>" alt="#">
                                </div>
                                <div class="content-box">
                    ...
                    <div class="col-xl-4 wow fadeInRight" data-wow-delay="100ms" data-wow-duration="1500ms">
                        <div class="projects-one__single">
                            <div class="projects-one__single-img">
                                <div class="inner">
                                    <img src="<?php echo e(asset('dapafue/assets/images/project/projects-v2-img2.jpg')); ?>" alt="#">
                                </div>
                            </div>
                    ...
                    <div class="col-xl-4 wow fadeInLeft" data-wow-delay="200ms" data-wow-duration="1500ms">
                        <div class="projects-one__single">
                            <div class="projects-one__single-img">
                                <div class="inner">
                                    <img src="<?php echo e(asset('dapafue/assets/images/project/projects-v2-img3.jpg')); ?>" alt="#">
                                </div>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInLeft" data-wow-delay="0ms"
                        ...
                        <div class="services-one__single text-center">
                            <div class="shape2"><img src="<?php echo e(asset('dapafue/assets/images/shapes/services-v1-shape12.png')); ?>" alt="#"></div>
        ...
        <section class="support-one">
            <div class="shape4"><img src="<?php echo e(asset('dapafue/assets/images/shapes/support-v1-shape4.png')); ?>" alt="#"></div>
            <div class="container">
                <div class="row">
                    <!--Start Support One Img-->
                    <div class="col-xl-6">
                        <div class="support-one__img">
                            <div class="shape1 rotate-me"><img src="<?php echo e(asset('dapafue/assets/images/shapes/support-v1-shape1.png')); ?>" alt="#">
                            </div>
                            <div class="inner">
                                <img src="<?php echo e(asset('dapafue/assets/images/resources/support-v1-img1.jpg')); ?>" alt="#">
                            </div>
                        </div>
                    </div>
                    <!--End Support One Img-->
                    ...
                    <div class="col-xl-6">
                        <div class="support-one__content">
                            <div class="shape2"><img src="<?php echo e(asset('dapafue/assets/images/shapes/support-v1-shape2.png')); ?>" alt="#"></div>
                            <div class="shape3"><img src="<?php echo e(asset('dapafue/assets/images/shapes/support-v1-shape3.png')); ?>" alt="#"></div>
                            <div class="sec-title">
                                <div class="sec-title__tagline">
                                    <div class="inner">
                                        <div class="round-box"><img src="<?php echo e(asset('dapafue/assets/images/shapes/sec-title-shape.png')); ?>"
                ...
                <div class="row">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow animated fadeInUp" data-wow-delay="0.1s">
                        <div class="team-one__single">
                            <div class="team-one__single-img">
                                <div class="inner">
                                    <img src="<?php echo e(asset('dapafue/assets/images/team/team-v1-img1.jpg')); ?>" alt="#">
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow animated fadeInUp" data-wow-delay="0.2s">
                        <div class="team-one__single">
                            <div class="team-one__single-img">
                                <div class="inner">
                                    <img src="<?php echo e(asset('dapafue/assets/images/team/team-v1-img2.jpg')); ?>" alt="#">
                                    <div class="social-link">
                                        <ul>
                                            <li>
                                                <a class="fb" href="#"><span class="icon-facebook"></span></a>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow animated fadeInUp" data-wow-delay="0.3s">
                        <div class="team-one__single">
                            <div class="team-one__single-img">
                                <div class="inner">
                                    <img src="<?php echo e(asset('dapafue/assets/images/team/team-v1-img3.jpg')); ?>" alt="#">
                                    <div class="social-link">
                                        <ul>
                                            <li>
                                                <a class="fb" href="#"><span class="icon-facebook"></span></a>
                    ...
                    <div class="col-xl-3 col-lg-6 col-md-6 wow animated fadeInUp" data-wow-delay="0.4s">
                        <div class="team-one__single">
                            <div class="team-one__single-img">
                                <div class="inner">
                                    <img src="<?php echo e(asset('dapafue/assets/images/team/team-v1-img4.jpg')); ?>" alt="#">
                                    <div class="social-link">
                                        <ul>
                                            <li>
                                                <a class="fb" href="#"><span class="icon-facebook"></span></a>
                        ...
                        <div class="col-xl-4 col-lg-6 col-md-6 wow animated fadeInUp" data-wow-delay="0.1s">
                            <div class="footer-one__single footer-one__about">
                                <div class="footer-one__about-logo">
                                    <a href="index.html"><img src="<?php echo e(asset('dapafue/assets/images/resources/footer-logo.png')); ?>" alt=""></a>
                                </div>
    ...
    <div class="mobile-nav__wrapper">
        ...
        <div class="mobile-nav__content">
            ...
            <div class="logo-box">
                <a href="index.html" aria-label="logo image"><img src="<?php echo e(asset('dapafue/assets/images/resources/footer-logo.png')); ?>"
                        width="143" alt="" /></a>
            </div>
            <!-- /.logo-box -->
    ...
    <script src="<?php echo e(asset('dapafue/assets/vendors/jquery/jquery-3.6.0.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/bootstrap/js/bootstrap.bundle.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/jarallax/jarallax.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/jquery-ajaxchimp/jquery.ajaxchimp.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/jquery-appear/jquery.appear.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/jquery-circle-progress/jquery.circle-progress.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/jquery-magnific-popup/jquery.magnific-popup.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/jquery-validate/jquery.validate.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/nouislider/nouislider.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/odometer/odometer.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/swiper/swiper.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/tiny-slider/tiny-slider.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/wnumb/wNumb.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/wow/wow.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/isotope/isotope.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/countdown/countdown.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/owl-carousel/owl.carousel.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/bxslider/jquery.bxslider.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/bootstrap-select/js/bootstrap-select.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/vegas/vegas.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/jquery-ui/jquery-ui.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/timepicker/timePicker.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/circleType/jquery.circleType.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/circleType/jquery.lettering.min.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/polyglot-language-switcher/jquery.polyglot.language.switcher.js')); ?>"></script>
    <script src="<?php echo e(asset('dapafue/assets/vendors/progress-bar/knob.js')); ?>"></script>

    <!-- template js -->
    <script src="<?php echo e(asset('dapafue/assets/js/ontech.js')); ?>"></script>
</body>
