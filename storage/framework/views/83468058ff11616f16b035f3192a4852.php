...
<style>
    body {
        background-image: url('<?php echo e(asset('html/assets/assets/media/auth/bg3.jpg')); ?>');
    }

    [data-bs-theme="dark"] body {
        background-image: url('<?php echo e(asset('html/assets/assets/media/auth/bg3-dark.jpg')); ?>');
    }
</style>
<!--end::Page bg image-->
    ...
    <div class="d-flex flex-center w-lg-50 pt-15 pt-lg-0 px-10">
        <div class="d-flex flex-center flex-lg-start flex-column">
            ...
            <h2 class="text-white fw-normal m-0">
                <img alt="Logo" src="<?php echo e(asset('html/assets/assets/media/logos/logo1.png')); ?>" class="h-100px app-sidebar-logo-default"/> JOURNAL MANAGEMENT SYSTEM
            </h2>
            <!--end::Title-->
        </div>
    </div>
...
<?php /**PATH C:\xampp\htdocs\stavops-app\resources\views/auth/login.blade.php ENDPATH**/ ?>